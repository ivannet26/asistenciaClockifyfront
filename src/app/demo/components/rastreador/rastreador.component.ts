...
export class RastreadorComponent implements OnInit, OnDestroy {
    ...
    guardarRegistro(nuevo: any) {
        this.rastreadorService.guardarRegistro(nuevo);
    }

    actualizarRegistroEnStorage(regActualizado: any) {
        this.rastreadorService.actualizarRegistro(regActualizado);
        this.cargarRegistros();
        this.agruparRegistros();
    }
    ...
    cargarRegistros() {
        ...
        this.registros = this.rastreadorService.cargarRegistros(miembroId);
    }

    agruparRegistros() {
        this.registrosAgrupados = this.rastreadorService.agruparRegistros(this.registros);
    }

    eliminarRegistro(registro: any) {
        this.rastreadorService.eliminarRegistro(registro);
        this.cargarRegistros();
        this.agruparRegistros();
    }

    formatearTiempo(ms: number): string {
        return this.rastreadorService.formatearTiempo(ms);
    }

    formatearHora(fecha: Date): string {
        return this.rastreadorService.formatearHora(fecha);
    }

    esMismaFecha(f1: Date, f2: Date): boolean {
        return this.rastreadorService.esMismaFecha(f1, f2);
    }
