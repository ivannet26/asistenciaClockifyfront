...
export class CalendarioComponent implements OnInit {
    ...
    calendarioIniciado: boolean = false;

    iniciarCalendario(): void {
        this.calendarioIniciado = true;
    }
    ...
    ngOnInit() {
        ...
        this.generarHoras();
        this.refrescarTodo();
        // Si ya hay registros se va a mostrar el calendario directo
        this.calendarioIniciado = this.registros.length > 0;
    }
